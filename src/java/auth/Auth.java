    ...
    public static Session register(String email, String password, String firstName,
        ...
        try ( SQLDb db = new SQLDb(Db.NAME)) {
            ...
            if (accountType == AccountType.TEACHER) {
                ...
                db.insert(Db.STUDENTS, uid, 0, null);
            }
        }
...
//        String token = register("bruh@gmail", "pass", "Kishan", "Patel", AccountType.TEACHER);
        Session session = login("bruh@gmail", "pass");

        Optional<Account> acc = Session.getAccountFromSession(session);
